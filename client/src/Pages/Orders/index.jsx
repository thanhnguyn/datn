                ...
                <div className='col2 w-[80%]'>
                    <div className='shadow-md rounded-md bg-white'>
                        <div className='py-2 px-3 border-b border-[rgba(0,0,0,0.1)]'>
                            <h2 >My orders</h2>
                            <p className='mt-0'>
                                There are <span className='font-bold text-primary'>{context?.ordersData?.filter((item) => item?.userId?._id === context?.userData?._id)?.length}</span> orders
                            </p>
                            <div className="relative overflow-x-auto mt-5">
                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        {
                                            context?.ordersData?.length > 0 && context?.ordersData
                                                ?.filter((item) => item?.userId?._id === context?.userData?._id)?.map((item, index) => {
                                                    return (
                                                        <>
